...
export default async function AboutPage() {
  ...
  // Fallback content if no CMS data exists
  if (!aboutData) {
    return (
  ...
  // Render content from Cosmic CMS
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          {metadata.mission_title && metadata.mission_content && (
            <section className="mb-12">
              <h2 className="text-2xl font-bold uppercase tracking-tight mb-4">
                {metadata.mission_title}
              </h2>
              <p className="text-gray-700 mb-4">
                {metadata.mission_content}
              </p>
            </section>
          )}
